...
\startchapter[title={Enlaces}]
  ...
  \startsection[title=Enlaces sencillos y dobles]
    ...
    \startsubsection[title=Ejemplos]
      ...
      % 1,2,3,4,5,6-hexametilciclohexano
      \startlinealignment[left]
        \framed[frame=off,location=middle]{
          \startchemical[frame=off,left=1800,width=3600,top=1900,bottom=2400]
            \chemical[SIX,B,R]
            \bottext{[SIX,B,R]}
          \stopchemical
        }
  ...
  \startsection[title=Enlaces sencillos orientados en el espacio]
    ...
    \startchemical
      \chemical[ONE,Z0=O,SR15,Z15,ED37] [H,H]
    \stopchemical

    \startchemical
      \chemical[ONE,Z0=O,SR15,Z15,EP37] [H,H]
    \stopchemical

    \startchemical
      \chemical[ONE,Z0=C,DR15,Z15] [O,O]
    \stopchemical
